...
app.config["SECRET"] = "78fh9f78shfs768fgs7f6" # chave de seguranca
socketio = SocketIO(app, cors_allowed_origins="*") # criou conexão entre diferentes máquinas que estão no mesmo site
